...
use crate::engine::{GraphEngine, NodeId, LinkId, Pin};
...
impl CanvasUI {
    ...
    pub fn draw(&mut self, ui: &mut egui::Ui) {
        ...
        for id in node_ids {
            ...
            painter.rect_filled(node_rect, 4.0, Color32::from_rgb(45, 45, 45));
        ...
        if let Some((start_node, pin_idx)) = self.active_link_start {
            ...
            painter.line_segment([start_pos, response.interact_pointer_pos().unwrap_or(Pos2::ZERO)], Stroke::new(2.0, Color32::YELLOW));
        }
    }
